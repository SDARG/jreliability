...
/**
 * The {@link ANDTerm} is a {@link Term} that interrelates its embedded
 * {@link TermUtils} with the AND operator}. <br>
...
public class ANDTerm extends AbstractHierarchicalTerm {
	...
	/**
	 * Constructs an {@link ANDTerm} with a given list of embedded {@link TermUtils}
	 * .
	 * 
	 * @param terms
	 *            the embedded terms
