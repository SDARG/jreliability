...
public class TestExample {
	 ...
	 */
	public Term get() {
		LiteralTerm<String> heaterLiteral = new LiteralTerm<>(heater);
		LiteralTerm<String> pump1Literal = new LiteralTerm<>(pump1);
		LiteralTerm<String> pump2Literal = new LiteralTerm<>(pump2);
