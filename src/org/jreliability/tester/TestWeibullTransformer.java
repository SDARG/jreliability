...
/**
 * The {@code TestWeibullTransformer} is a {@code Transformer} for the
 * {@code TestExample} that uses {@code WeibullReliabilityFunctions} as
 * {@code ReliabilityFunctions}.
 * 
 * @author glass
 * 
 */
public class TestWeibullTransformer implements Adapter<String, ReliabilityFunction> {
	 ...
	 * 
	 * @see
	 * org.jreliability.crau.ModelAdapter#transform(org.jreliability.crau.Model)
	 */
	@Override
