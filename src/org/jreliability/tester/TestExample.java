...
public class TestExample {
	 ...
	 */
	public Term get() {
		LiteralTerm heaterLiteral = new LiteralTerm(true, heater);
		LiteralTerm pump1Literal = new LiteralTerm(true, pump1);
		LiteralTerm pump2Literal = new LiteralTerm(true, pump2);
