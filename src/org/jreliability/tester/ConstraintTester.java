...
/**
 * The {@code ConstraintTester} can be used to test the
 * {@code BDDs.getConstraintBDD()} function.
 * 
 * @author glass
 * 
 */
public class ConstraintTester {
	...
	public static void main(String[] args) {
		...
		LinearTerm term = new LinearTerm(new ArrayList<Integer>(), new ArrayList<Term>(),
				LinearTerm.Comparator.LESSEQUAL, 8);
		term.add(1, x);
		term.add(1, y);
		term.add(2, z);
		term.add(2, a);
		...
		TermToBDDAdapter<String> transformer = new TermToBDDAdapter<String>(bddProvider);
