 ...
 * The term structure follows the scheme given by the polish notation, i.e., (operator operand1 ... operand2).
 * When printed or should be read in from string, the following formatting guidelines are strictly enforced:<br />
 * <p>
