...
public class BDDReliabilityFunction<T> implements ReliabilityFunction {
	 ...
	 * of the {@code BDD}.
	 */
	protected final Adapter<T, ReliabilityFunction> functionTransformer;
	 ...
	 *            reliabilityFunction
	 */
	public BDDReliabilityFunction(BDD<T> bdd, Adapter<T, ReliabilityFunction> functionTransformer) {
		super();
		this.bdd = bdd;
	...
	public double getY(final double x) {
		...
		final Adapter<T, Double> t = new Adapter<T, Double>() {
			/**
	 ...
	 */
	public Adapter<T, ReliabilityFunction> getTransformer() {
