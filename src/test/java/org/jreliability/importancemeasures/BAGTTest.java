...
public class BAGTTest {
	...
	public void testCoherentSystemPlusNormalized() {
		...
		assertEquals(0.40740296235326423, results.get("component1"), TEST_DELTA);
		assertEquals(1.4074154458916484, results.get("component2"), TEST_DELTA);
		assertEquals(1.5925872453884808, results.get("component3"), TEST_DELTA);
	}
	...
	public void testCoherentSystemMinusNormalized() {
		...
		assertEquals(0.5556999503051907, results.get("component1"), TEST_DELTA);
		assertEquals(0.44455976182908424, results.get("component2"), TEST_DELTA);
		assertEquals(0.25934723772784307, results.get("component3"), TEST_DELTA);
	}
	...
	public void testNonCoherentSystemMinusNormalized() {
		...
		assertEquals(0.7895185824205213, results.get("component1"), TEST_DELTA);
		assertEquals(0.21028052240651565, results.get("component2"), TEST_DELTA);
		assertEquals(0.05253059315391258, results.get("component3"), TEST_DELTA); 
	}
...
//		
//		assertEquals(Double.POSITIVE_INFINITY, results.get("component1"), TEST_DELTA);
//		assertEquals(?, results.get("component2"), TEST_DELTA);
//		assertEquals(?, results.get("component3"), TEST_DELTA);
//	}
	...
	public void testTimeInconsistentNonCoherentSystemMinusNormalized() {
		...
		assertEquals(0.3078814972787515, results.get("component1"), TEST_DELTA);
		assertEquals(0.641971720727645, results.get("component2"), TEST_DELTA);
		assertEquals(0.025709816626928825, results.get("component3"), TEST_DELTA);	
		assertEquals(0.641971720727645, results.get("component4"), TEST_DELTA);		
		assertEquals(0.02061313256860128, results.get("component5"), TEST_DELTA);
	}
...
//	
//		results = im.calculate(BAGT.Variant.PLUS);
//		assertEquals(?, results.get("component1"), TEST_DELTA);
//		assertEquals(?, results.get("component2"), TEST_DELTA);
//		assertEquals(?, results.get("component3"), TEST_DELTA);
//		assertEquals(?, results.get("component4"), TEST_DELTA);
//		assertEquals(?, results.get("component5"), TEST_DELTA);
//	}
}
