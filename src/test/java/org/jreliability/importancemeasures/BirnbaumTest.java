...
public class BirnbaumTest {
	...
	public void testNonCoherentSystemAtTime2() {
		...
		assertEquals(0.019024905568074547, results.get("component3"), TEST_DELTA);
	}
	...
	public void testNonCoherentSystemAtTime100() {
		...
		assertEquals(0.08554821486874875, results.get("component3"), TEST_DELTA);
	}
	...
	public void testNonCoherentSystemAtTime200() {
		...
		assertEquals(0.01583688671206782, results.get("component3"), TEST_DELTA);
	}
	...
	public void testTimeInconsistentNonCoherentSystemAtTime1() {
		...
		assertEquals(0.006526981004286112, results.get("component3"), TEST_DELTA);
	...
	public void testTimeInconsistentNonCoherentSystemAtTime50() {
		...
		assertEquals(0.12415757908083602, results.get("component3"), TEST_DELTA);
	...
	public void testTimeInconsistentNonCoherentSystemAtTime100() {
		...
		assertEquals(0.01819222351960241, results.get("component3"), TEST_DELTA);
