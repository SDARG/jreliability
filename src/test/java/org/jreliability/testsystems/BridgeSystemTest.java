...
public class BridgeSystemTest {
	...
	public void testBridgeSystem() {
		...
		Assertions.assertEquals(0.99897497, systemReliability.getY(0.1), TEST_DELTA);
		Assertions.assertEquals(0.99055298, systemReliability.getY(0.3), TEST_DELTA);
		Assertions.assertEquals(0.91912372, systemReliability.getY(0.9), TEST_DELTA);
		Assertions.assertEquals(0.55972244, systemReliability.getY(2.7), TEST_DELTA);
		Assertions.assertEquals(0.09472739, systemReliability.getY(8), TEST_DELTA);
		Assertions.assertEquals(0.00055310, systemReliability.getY(25), TEST_DELTA);
	}
}
